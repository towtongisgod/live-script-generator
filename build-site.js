...
const sources = [
  ...
  ['/config/accounts.js', path.join('config', 'accounts.js'), 'text/javascript; charset=utf-8'],
  ['/config/personas.js', path.join('config', 'personas.js'), 'text/javascript; charset=utf-8'],
  ['/config/patterns.js', path.join('config', 'patterns.js'), 'text/javascript; charset=utf-8'],
  ['/config/august-test-plan.js', path.join('config', 'august-test-plan.js'), 'text/javascript; charset=utf-8'],
